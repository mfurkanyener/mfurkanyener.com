            ...
            <Navbar scrollToSection={scrollToSection} />
                <div className="page-container">
                    ...
                    <Section ref={homeRef} id="home">
                        <div className="main-intro">
                            ...
                            <p className="intro-text">I'm <strong>Muhammed Furkan Yener, </strong>a Computer Engineer
                                specialized in React and JavaScript, and I create innovative web solutions focused on
                                user
                    ...
                    <Section ref={aboutRef} id="about">
                        <h1>About Me</h1>
                        <p className="about">I have extensive experience in technology projects and social
                            responsibility. At the ‘Öğrencilerin Sesi’ Platform, I led community-based projects, which
                            helped me develop a strong sense of social responsibility. During my internship at
                            Controlix, I gained comprehensive knowledge in IoT, embedded systems, and commercial
                            satellite projects. I continuously improve myself in innovative fields such as deep
                            learning, blockchain (Web3), and data science. Additionally, I have strengthened my
                            experience in building interactive and dynamic user interfaces using frontend technologies
                            like React and JavaScript.

                            I aim to produce innovative solutions in the digital world by combining my leadership and
                            technical skills. I pursue excellence in every project and strive to offer creative
                            solutions to accelerate digital transformation. And yes, sometimes I escape from code and
                            get lost in nature. But don’t worry, even when I set up my tent, I’m still looking for a
                            Wi-Fi signal! </p>
                    </Section>
